...
class SleepImpactScreen extends StatefulWidget {
  ...
  @override
  State<SleepImpactScreen> createState() => _SleepImpactScreenState();
}

class _SleepImpactScreenState extends State<SleepImpactScreen> {
  String? selectedOption;

  String getMessage() {
    if (selectedOption == "Yes") {
      return "We’ll provide sleep tips and relaxation routines to help manage sleep changes during your cycle.";
    } else if (selectedOption == "No") {
      return "Great! We’ll still monitor your cycle and overall wellness.";
    } else if (selectedOption == "NotSure") {
      return "No worries! We’ll help you track sleep patterns and understand changes over time.";
    }
    return "";
  }
